...
# 7. Deeper dive into factor variables

```{r, message=FALSE}
# Get data
Bicycle <- read_csv(here("ZDatasets","Bicycle.csv"))
Bicycle$day <- Bicycle$day |> as.factor()
```
...
Bicycle$weekend <-Bicycle$weekend %>% fct_recode("Weekend" = "TRUE","Weekday"  = "FALSE")
Bicycle$weekend |> head()
```
